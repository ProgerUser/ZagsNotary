...
//	
	public interface FRREP extends Library {
		public String _SHOWREPORT(String DLLOPTIONS, String USERNAME, String PASSW, String CONNECT_STRING,
				String SERVERNAME, String SID, String Edit_Enable, String Generate_Type, String Dir,
				String Use_Convertation, String File_Name, String REPORT_FILE, String REPORT_TYPE_ID, String REPORT_ID,
				String REP_NAME, String REPORT_SORT, String P1, String P2, String P3, String P4, String P5, String P6,
...
//		dbDisconnect();
//
//		FRREP lib = (FRREP) Native.loadLibrary("C:/MJ_/bin/frrep.dll", FRREP.class);
//		String ret = lib._SHOWREPORT("RUN", // DLLOPTIONS
//				"xxi", // USERNAME
//				"123", // PASSW
//				"localhost:1521:xe", // CONNECT_STRING
//				"xe", // SERVERNAME
//				sid, // SID
//				"N", // Edit_Enable
//				"F", // Generate_Type
